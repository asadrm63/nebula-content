...
-- VAT  | Holy See (Vatican City State) | Europe    | Southern Europe |         0.4 |      1929 |       1000 |                |   9.00 |
...
-- Clue #4: We're booking the first flight out – maybe we've actually got a chance to catch her this time.
 ...
 SELECT * FROM city JOIN country ON city.countrycode = country.code WHERE countrycode='SMR';
  3170 | Serravalle |
